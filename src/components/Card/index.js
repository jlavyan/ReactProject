      ...
      <View style={[styles.card, {backgroundColor: color}]}>
            ...
            <View style={styles.info}>
              <Text style={styles.infoTextBig}>
                ...
                {_.isEqual(type, 3) && (
                  <Text style={{color: colors.white}}>
                    /<Text style={{color: 'red'}}>{blood[1]}</Text>
                  </Text>
                )}
              ...
              {_.isEqual(type, 2) && (
                <Text style={styles.infoTextBig}>
                  ...
                  <View style={{paddingStart: 5}}>
                  <Text style={{fontSize: 12, color: '#FFF'}}>bpm</Text>
                  </View>        
        ...
        {_.isEqual(type, 4) && (
          <View style={styles.titleContainerCentered}>
            <Icon
              type="FontAwesome"
              style={styles.iconTitleInvert}
              name="meh"
            />
            <Text style={styles.textTitleInvert}>facexxxxxxx</Text>
          </View>
        )}
      </View>
    </View>
